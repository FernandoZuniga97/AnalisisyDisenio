...
namespace MyWinFormsApp.src.modulo4
{
    public partial class ReporteExcepcion : Form
    {
        ...
        private void ReporteExcepcion_Load( object sender, System.EventArgs e )
        {
            ...
            dispositivos.Add( new DispositivosNR { ID = "DNR-046", Fecha = "04/09/2025", Cliente = "Raúl Pineda", Dispositivo = "Samsung S23", Estado = "Reparado", Dias = "45", MontoP = "1926" } );
            dispositivos.Add( new DispositivosNR { ID = "DNR-047", Fecha = "27/10/2025", Cliente = "Carlos García", Dispositivo = "Samsung S22", Estado = "En espera", Dias = "54", MontoP = "3279" } );
            dispositivos.Add( new DispositivosNR { ID = "DNR-048", Fecha = "09/10/2025", Cliente = "Miguel Sánchez", Dispositivo = "Samsung S24", Estado = "Reparado", Dias = "77", MontoP = "449" } );
            ...
            dispositivos.Add( new DispositivosNR { ID = "DNR-052", Fecha = "21/09/2025", Cliente = "Raúl Pineda", Dispositivo = "Huawei P40", Estado = "Reparado", Dias = "65", MontoP = "738" } );
            ...
            //dispositivos.Add( new DispositivosNR { ID = "DNR-056", Fecha = "01/10/2025", Cliente = "Marta Ortiz", Dispositivo = "Samsung S20", Estado = "Reparado", Dias = "68", MontoP = "1516" } );
            ...
            //dispositivos.Add( new DispositivosNR { ID = "DNR-058", Fecha = "04/10/2025", Cliente = "Jorge Castillo", Dispositivo = "Google Pixel 8", Estado = "Reparado", Dias = "70", MontoP = "2212" } );
            ...
            //dispositivos.Add( new DispositivosNR { ID = "DNR-060", Fecha = "30/10/2025", Cliente = "Lucía Fernández", Dispositivo = "Samsung S22", Estado = "Reparado", Dias = "61", MontoP = "1244" } );
