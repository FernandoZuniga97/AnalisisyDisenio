...
namespace MyWinFormsApp
{
    public class DispositivosnRyRForm : Form
    {
        ...
        private void DispositivosnRyRForm_Load(object sender, EventArgs e)
        {
            ...
            {
                new DispositivosnRyR { Numero = 1, Tipo = "Botón de encendido", Frecuencia = 2 },
                new DispositivosnRyR { Numero = 2, Tipo = "Placa lógica dañada", Frecuencia = 2 },
                new DispositivosnRyR { Numero = 3, Tipo = "Puerto de carga malo", Frecuencia = 8 },
                new DispositivosnRyR { Numero = 4, Tipo = "Pantalla rota", Frecuencia = 14 },
                new DispositivosnRyR { Numero = 5, Tipo = "Batería defectuosa", Frecuencia = 4 },
                new DispositivosnRyR { Numero = 6, Tipo = "Falla de software", Frecuencia = 1 }
            };
